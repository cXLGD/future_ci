                ...
                <form action="" method="post" class="cmxform">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">添加合作伙伴</div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <div class="input-group"><span class="input-group-addon">企业名称</span>
                                        <input type="text" name="f_name" value="<?php set_value('f_name'); ?>" class="form-control">
                                    </div>
                                    <?php echo form_error('f_name'); ?>
                                </div>
                                <div class="form-group">
                                    <div class="input-group"><span class="input-group-addon">企业地址链接</span>
                                        <input type="text" name="f_url" value="<?php set_value('f_url'); ?>" class="form-control">
                                    </div>
                                    <?php echo form_error('f_url'); ?>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
